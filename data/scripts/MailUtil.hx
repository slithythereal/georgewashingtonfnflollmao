 ...
 */
public var allMailEver:Map<String, {mailID:String, letterID:String, desc:String}> =[
...
public var mailData:Map<String, {letterID:String, desc:String}> = [ 
...
public var allMail:Array<String> = ['potus', 'toucan', 'brazil', 'whitehouse', 'welcomeback'];
